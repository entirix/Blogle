...
/**
 * @package WordPress
 * @subpackage Blogle-WordPress-Theme
 * @since Blogle 1.0
 */
?><!doctype html>
...
<head id="<?php echo of_get_option('meta_headid'); ?>" data-template-set="wapulo-wordpress-theme">
    ...
    <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Open+Sans+Condensed:300|Merriweather:400,300,300italic,400italic,700,700italic|Roboto+Slab:400,300" />
...
<body <?php body_class(); ?>>
	...
	<header id="header" role="header">
			<a id="blog-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
			<?php if (true == of_get_option('head_logo')) {
			echo '<img src="'.of_get_option("head_logo").'" alt="Blog Logo" >';
			} ?>
			</a>
