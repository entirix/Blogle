...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Theme Options', 'html5reset'),
		'type' => 'heading');


		$options[] = array(
			'name' => __('Welcome to Blogle Theme Options', 'html5reset'),
			'desc' => __(
				"Thank You for Purchasing my Premium Theme. Navigate through the tabs to change options. For more details read the documentation. Thanks.", 
				'html5reset'),
			);
...
$options[] = array(
	...
	$options[] = array(
		...
		'desc' => __("", 'html5reset'),
		'id' => 'footer_control',
		'std' => 'Developed By Wapulo',
		'type' => 'text');

$options[] = array(
	'name' => __('Styles', 'html5reset'),
	'type' => 'heading');
	...
	$defined_stylesheets = array(
		...
		get_stylesheet_directory_uri() . '/css/grey.css' => "Grey",
		get_stylesheet_directory_uri() . '/css/brown.css' => "Brown",
		get_stylesheet_directory_uri() . '/css/green.css' => "Green",
		get_stylesheet_directory_uri() . '/css/pink.css' => "Pink",
		get_stylesheet_directory_uri() . '/css/teal.css' => "Teal",
		get_stylesheet_directory_uri() . '/css/red.css' => "Red"
	);
	$options[] = array( "name" => "Select a Stylesheet to be Loaded",
		"desc" => "Choose the color palette.",
		"id" => "stylesheet",
		"std" => "0",
		"type" => "select",
